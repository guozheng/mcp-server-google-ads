import asyncio
from server import list_client_accounts, list_campaigns, is_manager_account, create_campaign_budget, create_display_campaign
import json
import logging
import datetime
...
def test_create_display_campaign():
    ...
    campaign = {
        "name": "Test Campaign: " + str(datetime.datetime.now()),
